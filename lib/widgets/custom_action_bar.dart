...
import 'package:shop_a_lot/screens/cart_page.dart';
...
class CustomActionBar extends StatelessWidget {
  ...
  CustomActionBar({required this.title, required this.hasBackArrrow, required this.hasTitle, required this.hasBackground});
